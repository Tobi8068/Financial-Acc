...
export function Navbar() {
  return (
    <nav className="flex items-center justify-between px-6 py-4 max-h-[7%] shadow-lg">
      ...
      <Link to="/auth/signin" className="px-4 py-2 rounded-lg bg-[#3A3B55] text-white hover:bg-gray-700">
        Sign In
      </Link>
    </nav>
  );
